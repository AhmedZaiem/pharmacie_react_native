...
const defaultOrdonnances = [
    {
        ...
        date: "2025-02-26",
        medicaments: [
            { idMedicament: "m001", quantiteParJour: 2, duree: 3 },
            { idMedicament: "m003", quantiteParJour: 1, duree: 7 }
        ]
    },
    {
        id: "o002",
        ...
        date: "2025-03-01",
        medicaments: [
            { idMedicament: "m002", quantiteParJour: 1, duree: 5 },
            { idMedicament: "m004", quantiteParJour: 3, duree: 2 }
        ]
    }
];
...
export const resetOrdonnances = async () => {
    await saveItem(ORDONNANCE_KEY, defaultOrdonnances);
};
